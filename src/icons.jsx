// Icon set — moved verbatim from Amelior8App.jsx. No emojis anywhere in the UI (BRAND.md).
...
export const Icon = {
  ...
  shirt: (s = 20, c = "currentColor") => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill={c} fillOpacity="0.15" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M15 3l4.5 2.2a1 1 0 01.55 1.05L19.4 10H17v9.5a1 1 0 01-1 1H8a1 1 0 01-1-1V10H4.6l-.65-3.75A1 1 0 014.5 5.2L9 3a3 3 0 006 0z" />
    </svg>
  ),
  medical: (s = 20, c = "currentColor") => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill={c} fillOpacity="0.15" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  homeFilled: (s = 20, c = "currentColor") => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill={c} stroke={c} strokeWidth="1.6" strokeLinejoin="round">
      <path d="M3.5 10.2L12 3.5l8.5 6.7V20a1 1 0 01-1 1h-15a1 1 0 01-1-1z" />
    </svg>
  ),
  heartFilled: (s = 20, c = "currentColor") => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill={c} stroke={c} strokeWidth="1.5" strokeLinejoin="round">
      <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
    </svg>
  ),
  userFilled: (s = 20, c = "currentColor") => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill={c} stroke={c} strokeWidth="1.5" strokeLinejoin="round">
      <circle cx="12" cy="8" r="4" /><path d="M4.5 20.5a7.5 7.5 0 0115 0z" />
    </svg>
  ),
...
export function renderIcon(iconName, size = 20, color = "currentColor") {
